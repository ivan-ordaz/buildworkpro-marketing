...
- 2026-06-26: Drafted Track 1 post #5 — "How to Read Construction Plans & Do a Takeoff" (`/blog/construction-plans-takeoff-guide/`). All checks pass (format, lint 0 errors, typecheck 0 errors, build; E2E skipped — Chromium download blocked in remote environment). PR opened on branch `content/construction-plans-takeoff-guide`.

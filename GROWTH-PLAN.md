...
- 2026-07-14: Drafted Track 1 post #5 — "How to Read Construction Plans and Do a Takeoff" (`/blog/how-to-do-a-construction-takeoff/`). All checks pass (format, lint 0 errors, typecheck 0 errors, build; E2E skipped — Chromium binary not found in remote environment). PR opened on branch `content/how-to-do-a-construction-takeoff`.

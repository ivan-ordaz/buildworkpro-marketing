...
- **Errors:** RFC 9457 problem details (`application/problem+json`) with a machine-readable `type` URL (whose fragment is a stable error code) and `request_id` for support.

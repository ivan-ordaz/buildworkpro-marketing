...
<figure style="margin: 1.5rem 0;">
  <video
    ...
    aria-label="Product tour: the dashboard, sales pipeline, bids, and projects modules"
  >
  ...
  <figcaption style="margin-top: 0.5rem; font-size: var(--sl-text-sm); color: var(--sl-color-gray-3);">
    Product tour: the dashboard and core modules — sales pipeline, bids, and projects — that this
    guide unlocks.
  </figcaption>
</figure>

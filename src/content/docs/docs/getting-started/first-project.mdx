...
![The New Project dialog with fields for name, customer, project type, status, priority, dates, and contract value](/docs-screenshots/getting-started/new-project-dialog.png)

![A project detail page showing the Overview tab, progress panel, and tabs for Phases & Tasks, Change Orders, Site Logs, Pay Apps, Invoices, and Time](/docs-screenshots/getting-started/project-detail-tabs.png)

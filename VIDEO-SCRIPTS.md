...
## Script 6 — "I Build Bids by Having a Conversation Now" (3–4 min, founder-voice)

**The play:** the AI-assistant page's story, shown live. This is the differentiator video — nobody else in the category can film it. Pair it with /features/ai-assistant/ as the landing page and pin it there. Founder-face: this one only works as you, because it's your real workflow at National Glass.

| #   | Scene        | You say                                                                                                                                                                                                                         | You do                                                                             |
| --- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| 1   | Hook         | "I run estimating for a glass company in Miami. This is how I build most of our bids now — not by opening the app. By having a conversation. Watch."                                                                            | Screen shows a Claude chat, BuildWorkPro open in another window. Phone optional.   |
| 2   | The ask      | "I give it what I got from the GC — scope, the measurements, what glass we're using. Plain English, like I'd brief an estimator."                                                                                               | Paste/dictate a short real-ish brief into the chat. Ask it to build the bid.       |
| 3   | It builds    | "And it builds the actual bid. In my account. Real line items, real prices from my catalog — not a text summary I have to retype."                                                                                              | Flip to BuildWorkPro; refresh; the new bid is there. Scroll the line items slowly. |
| 4   | Review       | "I'm not sending anything an AI wrote without looking at it. So I review it like I'd review a junior estimator's work — check the numbers, fix a line, check my margin."                                                        | Adjust one line item's price or quantity in BWP. Point at the totals updating.     |
| 5   | Send         | "Looks right. Send. That whole thing — brief to sent bid — took about the time it takes to pour a coffee."                                                                                                                      | Send the bid from BWP.                                                             |
| 6   | Payoff + CTA | "Works with Claude and ChatGPT, on my computer or my phone, and it's included in the $79 — not an add-on. If bidding nights and weekends is your bottleneck, this is the part of BuildWorkPro that gives you those hours back." | End card: buildworkpro.com/features/ai-assistant — "Included. $79/mo flat."        |

**Filming notes:** use the demo tenant with the product catalog seeded so prices resolve; rehearse the chat prompt once so the build step is smooth on camera; keep the chat window text large (mobile-width browser window reads better on video). Do NOT say "MCP" on camera — the page says "connect once from your AI's settings" and that's the right altitude.
